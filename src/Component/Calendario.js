...
export default function Calendario(){
    ...
    return(
        <Container fluid className='cont'>
            <Navbar bg="light" expand="lg" className='mb-3 mt-0 shadow-lg' style={{}}>
                <Container>
            ...
            <div className="container">
                <div className='animated mx-auto w-75'><h1>Selezionare la data in cui si intende prenotare</h1></div>
            </div>

            <Calendar
                showFixedNumberOfWeeks showNavigation showNeighboringMonth
                className='border border-3 border-dark mb-4'
                onClickDay={(day,e)=>handleClick(day,e)}
            />
